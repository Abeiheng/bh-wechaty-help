...
const listenType = ref<Array<number>>([])
</script>
      ...
      <div class="config">
        ...
        <el-form>
          ...
          <el-form-item label="监听条件">
            <el-checkbox-group v-model="listenType">
              <el-checkbox :value="0" name="type">黑名单词</el-checkbox>
              <el-checkbox :value="1" name="type">二维码</el-checkbox>
              <el-checkbox :value="2" name="type">链接</el-checkbox>
              <el-checkbox :value="3" name="type">手机号</el-checkbox>
            </el-checkbox-group>
          </el-form-item>
          <el-form-item label="黑名单词" v-if="listenType.includes(0)">
            <el-input
              placeholder="请输入你监听的黑名单词(使用#分割)"
              :rows="4"
              type="textarea"
              v-model="friend.verify"></el-input>
          </el-form-item>
          <el-form-item>
